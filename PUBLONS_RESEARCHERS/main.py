 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "df = pd.DataFrame(user_list,columns=['idd','investigadores','publicaciones','coments_verif','registr_editor_verif'])\n",
